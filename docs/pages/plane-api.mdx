...
<Callout type="info">
  ...
  You are free to call it from application code as well, but consider whether using
  `max_idle_seconds`, `lifetime_limit_seconds`, or exiting from your backend code instead.
</Callout>
